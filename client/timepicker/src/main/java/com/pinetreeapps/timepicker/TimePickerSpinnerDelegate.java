...
class TimePickerSpinnerDelegate extends TimePicker.AbstractTimePickerDelegate {
    ...
    private TwoDigitFormatter mTwoDigitFormatter = new TwoDigitFormatter();
...
//                        updateAmPmControl();
        ...
        mHourSpinnerInput = (EditText) mHourSpinner.findViewById(Resources.getSystem().getIdentifier("numberpicker_input", "id", "android"));
...
//                        updateAmPmControl();
        ...
        mMinuteSpinnerInput = (EditText) mMinuteSpinner.findViewById(Resources.getSystem().getIdentifier("numberpicker_input", "id", "android"));
...
//                }
//            });
//            mAmPmSpinnerInput = (EditText) mAmPmSpinner.findViewById(Resources.getSystem().getIdentifier("numberpicker_input", "id", "android"));
...
//        final String bestDateTimePattern = DateFormat.getBestDateTimePattern(mCurrentLocale, "hm" /* skeleton */);
//
...
//    }
    ...
    private void setDividerText() {
        ...
        mDivider.setTypeface(TypefaceHelper.get(mContext, TypefaceHelper.TYPEFACE_NAME));
...
//    }
    ...
    private void updateHourControl() {
        ...
        mHourSpinner.setFormatter(mHourWithTwoDigit ? mTwoDigitFormatter : null);
    }
    ...
    private void setContentDescriptions() {
        ...
        trySetContentDescription(mMinuteSpinner, incrementId, R.string.time_picker_increment_minute_button);
        trySetContentDescription(mMinuteSpinner, decrementId, R.string.time_picker_decrement_minute_button);
        // Hour
        trySetContentDescription(mHourSpinner, incrementId, R.string.time_picker_increment_hour_button);
        trySetContentDescription(mHourSpinner, decrementId, R.string.time_picker_decrement_hour_button);
        // AM/PM
//        if (mAmPmSpinner != null) {
//            trySetContentDescription(mAmPmSpinner, incrementId, R.string.time_picker_increment_set_pm_button);
//            trySetContentDescription(mAmPmSpinner, decrementId, R.string.time_picker_decrement_set_am_button);
//        }
    }
