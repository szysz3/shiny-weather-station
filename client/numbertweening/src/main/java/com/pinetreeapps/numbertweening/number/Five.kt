...
class Five private constructor() : Number(Five.points) {
    ...
    companion object {
        val instance: Five by lazy { Holder.instance }
        val points = arrayOf(floatArrayOf(0.806629834254144f, 0.110497237569061f),
