...
class Three private constructor() : Number(Three.points) {
    ...
    companion object {
        val instance: Three by lazy { Holder.instance }
        val points = arrayOf(floatArrayOf(0.361878453038674f, 0.298342541436464f),
