...
class Six private constructor() : Number(Six.points) {
    ...
    companion object {
        val instance: Six by lazy { Holder.instance }
        val points = arrayOf(floatArrayOf(0.607734806629834f, 0.110497237569061f),
